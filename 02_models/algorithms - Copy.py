...
# في ملف algorithms.py

# استيراد الدوال الجديدة
from your_notebook import nsga3, moead, improved_cl_nsga2

# تحديث قاموس ALGORITHMS
ALGORITHMS = {
    "Improved CL-NSGA-II": improved_cl_nsga2,
    "CL-NSGA-II (Proposed)": cl_nsga2,
    "Proposed w/o novelty (ablation)": nsga2_no_novelty,
    "NSGA-II": nsga2,
    "NSGA-III": nsga3,
    "MOEA/D": moead,
    "MOPSO": mopso,
